...
DEPLOY_NODE ()
{
seq 1 4 | xargs -I {} -P 4 scp install4node.sh node-{}.k8s.home.arpa:
seq 1 4 | xargs -I {} -P 4 ssh node-{}.k8s.home.arpa "./install4node.sh"
seq 1 4 | xargs -I {} -P 4 ssh node-{}.k8s.home.arpa "rm ./install4node.sh"
