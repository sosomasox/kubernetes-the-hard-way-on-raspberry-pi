...
if [ "$1" = "control-plane" ]; then
    ...
    seq 1 8 | xargs -I {} -P 8 scp uninstall4node.sh node-{}.k8s.home.arpa:
    seq 1 8 | xargs -I {} -P 8 ssh node-{}.k8s.home.arpa "./uninstall4node.sh"
    seq 1 8 | xargs -I {} -P 8 ssh node-{}.k8s.home.arpa "rm ./uninstall4node.sh"
    seq 1 8 | xargs -I {} -P 8 ssh node-{}.k8s.home.arpa "sync"
fi
