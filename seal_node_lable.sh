...
kubectl taint nodes control-plane-1.k8s.home.arpa node-role.kubernetes.io/control-plane:NoSchedule
kubectl taint nodes control-plane-2.k8s.home.arpa node-role.kubernetes.io/control-plane:NoSchedule
kubectl taint nodes control-plane-3.k8s.home.arpa node-role.kubernetes.io/control-plane:NoSchedule
